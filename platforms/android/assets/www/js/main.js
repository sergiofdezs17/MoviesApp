        ...
        theList.append(
                                                 '<li class="ui-body-a"  style="border: none">'+
                                                    ...
                                                    '<li class="ui-block-b" >'+
                                                        ...
                                                        '<div onclick="javascript:isFavorite('+rs.rows.item(i).id+',\'DbDetail\')" ><i class="fa fa-plus" aria-hidden="true" style="text-align:center;margin-left:45%;margin-top:35%;margin-bottom:25%;font-size:18px;font-weight:bold;"></i></div>'+
                                                    '</li>'+
                                                '</ul>'+
                                                '</li>');
        }
